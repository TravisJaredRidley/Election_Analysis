...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        with open(file_to_load) as election_data:
            ...
            tp = (total_county_votes / total_votes) * 100
           # f"Total Votes: {total_votes:,}\n"
            #print(total_votes)
            print(f"{county}: {tp:.1f}% ({total_county_votes:,})")
        if total_county_votes > lv:
            #print(lv)
            lv = total_county_votes
            lvt = county
        
    lvt = (
        f"\n-------------------------\n"
        f"Largest County Turnout: {lvt}\n"
        f"-------------------------\n\n")
    ...
    #print(total_county_votes)
       ...
       # county_vote_percentage = float(total_county_votes) / float(total_votes) * 100
        #county_votes = (
           # f"{largest_county}: {county_vote_percentage:.1f}% ({total_county_votes:,})\n")
   ...
   # if (county_vote_percentage > winning_count) and (total_county_votes > winning_percentage):
    #    winning_count = votes
